#
#  Be sure to run `pod spec lint xsliderPod.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  # Or just: s.author    = "Xudong"
  # s.authors            = { "Xudong" => "ziyingzhishang@163.com" }
  # s.social_media_url   = "http://twitter.com/xudong"
  ...
  s.exclude_files = "source/LICENSE"
